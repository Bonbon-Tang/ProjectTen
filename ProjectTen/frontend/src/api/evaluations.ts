...
export function evaluationPreflight(data: { task_category?: string; task_type: string; device_type?: string; image_id?: number; toolset_id?: number }) {
  return api.post('/evaluations/preflight', data);
}
