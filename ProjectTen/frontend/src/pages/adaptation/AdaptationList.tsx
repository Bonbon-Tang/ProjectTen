...
export default function AdaptationList() {
  ...
  const columns: ColumnsType<AdaptTask> = [
    { title: '任务名称', dataIndex: 'name', key: 'name', render: (text, record) => <Button type="link" style={{ padding: 0, fontWeight: 600 }} onClick={() => navigate(`/adaptation/${record.id}`)}>{text}</Button> },
