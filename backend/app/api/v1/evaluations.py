...
def create_evaluation(body: EvaluationCreate, request: Request,
    ...
    try:
        ...
        task = EvaluationService.create(
            ...
            task_category=norm.internal_task_category,
            task_type=norm.internal_task_type,
            device_type=norm.internal_device_type,
            device_count=norm.internal_device_count,
            image_id=norm.image_id,
            toolset_id=norm.tool_id,
            # operator-only
